...
for (var file in window.__karma__.files) {
    // this regex will match any path that contains js/spec and spec file ends with _spec.js
    // some specs files like below are not ends with _spec.js
    // js/spec/dashboard/donation.js
    // js/spec/courseware/updates_visibility.js
    // TODO! rename the above two files
