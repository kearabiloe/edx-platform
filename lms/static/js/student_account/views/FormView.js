    ...
    define([
        ...
        return Backbone.View.extend({
            ...
            buildForm: function( data ) {
                ...
                for ( i=0; i<len; i++ ) {
                    errorMessages = data[i].errorMessages || {};
                    if ( !_.isEmpty(errorMessages) ) {
                        data[i].errorMessages = this.escapeStrings( errorMessages );
                    }

                    instructions = data[i].instructions;
                    if ( instructions.length ) {
                       data[i].instructionsHtml = HtmlUtils.HTML(instructions);
                    }

                    label = data[i].label;
                    if ( label.length ) {
                       data[i].labelHtml = HtmlUtils.HTML(label);
                    }
